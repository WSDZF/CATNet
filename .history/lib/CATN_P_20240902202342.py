...
class CATNet(nn.Module):
    def __init__(self, nf=32, imagenet_pretrained=True):
        ...
        self.down1 = nn.Sequential(nn.Conv2d(64, nf, 1, bias=False), nn.BatchNorm2d(nf))
        self.down2 = nn.Sequential(nn.Conv2d(128, nf, 1, bias=False), nn.BatchNorm2d(nf))
        self.down3 = nn.Sequential(nn.Conv2d(320, nf, 1, bias=False), nn.BatchNorm2d(nf))
        self.down4 = nn.Sequential(nn.Conv2d(512, nf, 1, bias=False), nn.BatchNorm2d(nf))
        ...
        self.PCA = PCA(n=1, features=[64, 128, 320, 512], strides=[8, 4, 2, 1], patch=11, channel_head=[1, 1, 1, 1],
