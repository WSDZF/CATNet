...
from lib.PVT_PCA import CATNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth_path', type=str, default='D:\TANET_code\预训练模型\CATNet-P.pth')
    opt = parser.parse_args()

    # for _data_name in ['CAMO', 'COD10K', 'CHAMELEON']:
    for _data_name in ['CVC-ClinicDB']:
        data_path = 'D:\HSNet-main\dataset\TestDataset{}\images/'.format(_data_name)
        ...
        for i in range(test_loader.size):
            ...
            res5, res4, res3 = model(image)
            heatmap(feat_viz=res5, ori_img=image, save_path=save_path + name)
