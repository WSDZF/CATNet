...
from lib.CATN_P import CATNet as Network
from lib.CATN_P import affinity, edge
...
def train(train_loader, model, optimizer, epoch, save_path,test_path):
    ...
    try:
        ...
        test1path = 'D:\HSNet-main\dataset\TestDataset'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='D:\HSNet-main\dataset\TrainDataset',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='D:\HSNet-main\dataset\TestDataset',
                        help='the test rgb images root')

    parser.add_argument('--save_path', type=str,
                        default='./snapshot/CATN_P/',
