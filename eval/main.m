...
ResultMapPath = fullfile('D:','PraNet -DCA','results');
Models = {'pretrained-R'}; %{'UNet','UNet++','PraNet','SFA'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '../data/TestDataset/';
DataPath = fullfile('D:','PraNet -DCA','data','TestDataset')
Datasets = {'CVC-300','CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir'}; %{'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'};
% Datasets = {'CVC-300', 'CVC-ColonDB', 'Kvasir'};
...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        imgFiles = dir(strcat(resMapPath,'*.png'));
